...
import com.budko.translatorproject.logic.GrammarTree;
...
public class lab4 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        primaryStage.setTitle("Відношення передування Будько Дмитро ТР-42");

        GrammarTree tree = new GrammarTree("d:\\labs_6_semestr\\sapr\\my_1_lab\\TranslatorProject\\grammarTable.txt");
